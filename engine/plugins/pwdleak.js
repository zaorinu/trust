...
(function() {
        ...
        for (const mutation of mutations) {
            ...
            if (mutation.attributeName === 'type') {
                ...
                if (rawType !== 'password' && rawType !== SECRET_TOKEN) {
                    ...
                    console.warn("Password Protection: Unauthorized type change blocked.");
                } 
    ...
    console.log(`%cTrust: Password protection plugin enabled`, "background:green;padding:2px 5px;border-radius:3px;font-weight:bold;");
})();